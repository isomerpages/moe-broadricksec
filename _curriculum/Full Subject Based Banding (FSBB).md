...
Broadrick Secondary School has implemented Full Subject-Based Banding (Full SBB) from 2022. With Full SBB, we are moving towards one secondary education, with many subject bands, to better meet our students’ learning needs.&nbsp;
...
The subject classes will be organised based on their respective course levels (G1, G2, G3). The common learning experience through the mixed form classes creates a valuable setting for students to mingle, build meaningful friendships, and appreciate different perspectives.&nbsp;  
